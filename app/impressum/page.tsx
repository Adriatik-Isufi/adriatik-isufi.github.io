        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link
                href="/#angebot"
                className="text-sm font-medium text-gray-700 dark:text-slate-200 hover:text-[#1351d8] transition-colors"
              >
                Angebot
              </Link>
              <Link
                  ...
                  {activeSidebarSection === "legal" && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <Link
                          href="/impressum"
                          className="block px-4 py-3 text-base font-medium text-[#1351d8] bg-blue-50 dark:bg-[#1351d8]/15 rounded-lg transition-colors border border-gray-100 dark:border-slate-800 hover:border-[#1351d8]/20"
                        >
      ...
      <main className="pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-50">Impressum</h1>
            </CardHeader>
            <CardContent className="space-y-8">
              {/* Contact Information */}
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50">Kontaktdaten</h2>
                <div className="bg-gray-50 dark:bg-slate-900 p-6 rounded-lg space-y-2">
                  <p className="font-semibold text-gray-900 dark:text-slate-50">Fahrschule 06</p>
                  <p className="text-gray-700 dark:text-slate-200">Inhaber: Vaxhid Mustafa</p>
                  <p className="text-gray-700 dark:text-slate-200">Oberdorf 4</p>
                  <p className="text-gray-700 dark:text-slate-200">5057 Reitnau</p>
                  <p className="text-gray-700 dark:text-slate-200">Telefon: +41 76 340 22 01</p>
                  <p className="text-gray-700 dark:text-slate-200">E-Mail: info@fahrschule06.ch</p>
                </div>
              </div>

              {/* Disclaimer */}
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50">Haftungsausschluss</h2>
              ...
              {/* Links Disclaimer */}
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50">Haftungsausschluss für Links</h2>
                <div className="prose prose-gray max-w-none">
                  <p className="text-gray-700 dark:text-slate-200 leading-relaxed">
