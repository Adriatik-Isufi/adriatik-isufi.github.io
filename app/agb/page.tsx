...
export default function AGBPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/#angebot" className="text-sm font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] transition-colors">
                Angebot
              </Link>
              <Link href="/#preise" className="text-sm font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] transition-colors">
                Preise
              </Link>
              ...
              <Link href="/#kontakt" className="text-sm font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] transition-colors">
                Kontakt
              </Link>
              <ThemeToggle />
              <Link href="/#kontakt">
                ...
                <div className="px-6 pb-6">
                  {activeSidebarSection === "navigation" && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <Link href="/" className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors border border-gray-100 dark:border-neutral-800 hover:border-[#1351d8]/20">
                          Startseite
                        </Link>
                        <Link href="/#angebot" className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors border border-gray-100 dark:border-neutral-800 hover:border-[#1351d8]/20">
                          Angebot
                        </Link>
                        <Link href="/#preise" className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors border border-gray-100 dark:border-neutral-800 hover:border-[#1351d8]/20">
                          Preise
                        </Link>
                        <Link href="/#kontakt" className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors border border-gray-100 dark:border-neutral-800 hover:border-[#1351d8]/20">
                          Kontakt
                        </Link>
                      </div>
                      <div className="pt-4">
                      ...
                      <div className="pt-4 border-t border-gray-200 dark:border-neutral-800 space-y-3">
                        <a href="tel:+41763402201" className="flex items-center gap-3 text-[#1351d8] hover:text-[#1351d8]/80 transition-colors p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-[#1351d8]/10">
                  ...
                  {activeSidebarSection === "legal" && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <Link href="/impressum" className="block w-full text-left px-4 py-3 text-base font-medium text-gray-700 dark:text-neutral-300 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors border border-gray-100 dark:border-neutral-800 hover:border-[#1351d8]/20">
                          Impressum
                        </Link>
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 bg-gradient-to-b from-blue-50 to-white dark:to-neutral-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-neutral-50 mb-4 text-balance">Allgemeine Geschäftsbedingungen (AGB)</h1>
          <p className="text-gray-600 dark:text-neutral-400">Stand: 01.01.2026</p>
        </div>
      </section>
        ...
        <div className="flex gap-12">
          ...
          <aside className="hidden lg:block w-72 shrink-0">
            <div className="sticky top-24">
              <h3 className="text-sm font-semibold text-gray-500 dark:text-neutral-400 uppercase tracking-wider mb-4">Inhaltsverzeichnis</h3>
              <nav className="space-y-1 max-h-[calc(100vh-8rem)] overflow-y-auto scrollbar-hide">
                {sections.map((section) => (
                  <button
                    key={section.id}
                    onClick={() => scrollToSection(section.id)}
                    className="flex items-center gap-2 w-full text-left px-3 py-2 text-sm text-gray-600 dark:text-neutral-400 hover:text-[#1351d8] hover:bg-blue-50 dark:hover:bg-[#1351d8]/10 rounded-lg transition-colors"
                  >
          ...
          <main className="flex-1 min-w-0">
            <div className="prose prose-gray max-w-none">
              ...
              <section id="allgemein" className="mb-12 scroll-mt-24">
                ...
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed mt-4">
              ...
              <section id="fahrunterricht" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-neutral-50 mb-6 pb-3 border-b-2 border-[#1351d8]/20">Fahrunterricht</h2>
              </section>

              {/* Gewährleistung */}
              <section id="gewaehrleistung" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Gewährleistung</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="lektionsdauer" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Lektionsdauer</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="lernfahrausweis" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Lernfahrausweis</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="terminbuchungen" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Terminbuchungen</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kontrollfahrten" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Kontrollfahrten</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="abmeldungen" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Abmeldungen, Verspätungen und Absenzen bei Fahrlektionen und Prüfungen</h3>
              ...
              <section id="alkohol" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Alkohol, Medikamente und Drogen</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="fahrzeuge" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Fahrzeuge</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="versicherung-admin" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Versicherungs- und Adminpauschale bei Fahrlektionen (Kat. B)</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="preise" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Preise</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="pruefung" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Praktische Prüfung und Anmeldung</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed mb-4">
              ...
              <section id="zahlungsbedingungen" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Zahlungsbedingungen</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed mb-4">
              ...
              <section id="kurse" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-neutral-50 mb-6 pb-3 border-b-2 border-[#1351d8]/20">Kurse und Veranstaltungen (VKU)</h2>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="gruppengroesse" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Gruppengrösse</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kurs-anmeldung" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Anmeldung</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kurs-umbuchung" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Umbuchung, Stornierung und Versäumnis von Kursen</h3>
                <ul className="list-disc list-inside text-gray-700 dark:text-neutral-300 space-y-2">
              ...
              <section id="kurs-versaeumnis" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Versäumte Kursteile</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kursbestaetigung" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Kursbestätigung</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="ausschluss" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Ausschluss</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kursgeld" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Kursgeld / Bezahlung</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="kursorganisation" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Organisatorisches und Kursabsage durch Veranstalter</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed mb-4">
              ...
              <section id="geschenkgutscheine" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-neutral-50 mb-6 pb-3 border-b-2 border-[#1351d8]/20">Geschenkgutscheine</h2>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-neutral-50 mb-6 pb-3 border-b-2 border-[#1351d8]/20">Schlussbestimmungen</h2>
              </section>

              {/* Datenschutz */}
              <section id="datenschutz" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Datenschutz</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="copyright" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Copyright</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
              ...
              <section id="gerichtsstand" className="mb-12 scroll-mt-24">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-neutral-50 mb-4">Gerichtsstand</h3>
                <p className="text-gray-700 dark:text-neutral-300 leading-relaxed">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400 dark:text-neutral-500">&copy; 2026 Fahrschule 06. Alle Rechte vorbehalten.</p>
            <div className="flex gap-6">
              <Link href="/impressum" className="text-sm text-gray-400 dark:text-neutral-500 hover:text-white transition-colors">
                Impressum
              </Link>
              <Link href="/agb/" className="text-sm text-gray-400 dark:text-neutral-500 hover:text-white transition-colors font-medium">
                AGB
              </Link>
            </div>
          </div>
