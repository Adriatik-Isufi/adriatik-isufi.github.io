...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 dark:from-slate-900 to-white dark:to-slate-950 flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="mt-12 text-sm text-gray-500 dark:text-slate-300">
